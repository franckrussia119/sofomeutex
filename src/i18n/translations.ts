...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    darkHero: {
      ...
      subheading: 'Wardiere & Co. Institutional Commodity Trading',
      headlinePart1: 'Sovereign Transatlantic',
      headlinePart2: 'Import Corridors',
      description: 'Sole accredited distributor of Double A Paper in Cameroon, alongside direct volume allocations for Argentine gourmet popcorn, sorted European textiles, and high-purity construction gypsum plaster.',
      btnExplore: 'Explore Four Core Pillars',
      ...
      statPillarsDesc: 'Exclusive Double A paper, grains, European apparel, plaster.',
    ...
    carousel: {
      ...
      subheadline: 'Sole authorized importer of Double A Paper in Cameroon, paired with direct volume supply lines for Argentine popcorn, sorted European textiles, and high-grade industrial gypsum plaster.',
      btnSpecs: 'Specifications',
      btnInquire: 'Inquire FCL',
      slideCounter: 'Pillar',
      badgeCorridors: 'Strategic Import Corridors',
      badgeHub: 'Port of Douala Hub',
      headingPart1: 'The Four Sovereign Pillars of',
    ...
    home: {
      ...
      pillarsDescription: 'Four dedicated global commodities imported directly into the Port of Douala for institutional distributors, national printers, and industrial processors.',
    ...
    supply: {
      ...
      title: 'Four Sovereign Import Pillars',
    ...
    logistics: {
      ...
      protocolDesc: 'How Wardiere & Co. guarantees container integrity, zero cargo damage, and expedited customs release at Douala Port Terminal (PAD/DIT).',
    ...
    about: {
      ...
      subtitle: 'Founded on the principles of American institutional corporate governance and sovereign African distribution strength, Wardiere & Co. links top-tier global manufacturers directly with enterprise buyers in Cameroon and Central Africa.',
      storyTitle: 'Bridging Continents Through Sovereign Mill & Farm Contracts',
      storyP1: 'Traditional commodity trading in Central Africa has long been hampered by informal brokerage chains, inconsistent grading, and unpredictable maritime delays. Wardiere & Co. was established to introduce an uncompromising tier-one corporate standard to the region.',
      ...
      storyP3: 'We replicated that identical institutional model across our other core verticals: working directly with the Argentine Popcorn Chamber (CAPPEC), premier textile recycling consortia in Western Europe, and high-purity gypsum kilns in the Mediterranean basin.',
      capacityLabel: 'Annual Sourcing Capacity',
      directLabel: 'Zero Broker Markups',
      dualDesks: 'Dual Transatlantic & Douala Executive Desks',
      charterEyebrow: 'Our Operating Charter',
      charterTitle: 'The Four Cornerstones of Wardiere & Co.',
      ...
      headquartersInfo: 'Headquartered in New York with Operations Hub in Douala, Cameroon',
    ...
    clients: {
      ...
      eligibilityTitle: 'How to Become a Certified Wardiere Wholesale Partner',
    ...
    contact: {
      ...
      nyTitle: 'New York Corporate Office',
    ...
    footer: {
      ...
      tagline: 'Wardiere & Co. is a premier transatlantic trading house operating high-volume containerized import corridors into the Port of Douala and the Central African Economic and Monetary Community (CEMAC).',
      brandDesc: 'Wardiere & Co. is an American-standard transatlantic trading house operating high-volume containerized import corridors into the Port of Douala and the Central African Economic and Monetary Community (CEMAC).',
      ...
      copyright: '© 2026 Wardiere & Co. All rights reserved. Exclusive Distributor of Double A Paper in Cameroon.'
    }
  },
  fr: {
    nav: {
    ...
    darkHero: {
      ...
      subheading: 'Wardiere & Co. Négoce Institutionnel de Matières Premières',
      headlinePart1: 'Corridors d’Importation',
      headlinePart2: 'Transatlantiques Souverains',
      description: 'Importateur exclusif agréé du Papier Double A au Cameroun, aux côtés de lignes d’approvisionnement directes pour le maïs à pop-corn d’Argentine, la friperie et chaussures européennes triées, et le plâtre industriel haute pureté.',
      btnExplore: 'Découvrir les 4 Piliers',
      ...
      statPillarsDesc: 'Papier Double A exclusif, céréales, textile européen, plâtre.',
    ...
    carousel: {
      ...
      subheadline: 'Seul importateur autorisé du Papier Double A au Cameroun, associé à des filières d’approvisionnement en gros pour le pop-corn d’Argentine, les textiles triés d’Europe et le plâtre industriel pur.',
      ...
      headingPart1: 'Les Quatre Piliers Souverains de',
    ...
    home: {
      ...
      pillarsDescription: 'Quatre matières premières mondiales importées directement au Port de Douala pour les distributeurs institutionnels, imprimeurs nationaux et transformateurs industriels.',
    ...
    supply: {
      ...
      title: 'Quatre Piliers Souverains d’Importation',
    ...
    logistics: {
      ...
      protocolDesc: 'Comment Wardiere & Co. garantit l’intégrité des conteneurs, zéro casse et une mainlevée douanière rapide au Terminal Portuaire de Douala (PAD/DIT).',
    ...
    about: {
      ...
      subtitle: 'Fondée sur les règles de gouvernance d’entreprise américaine et la puissance de distribution africaine, Wardiere & Co. relie directement les plus grands industriels mondiaux aux grossistes du Cameroun et d’Afrique Centrale.',
      storyTitle: 'Rapprocher les Continents par des Contrats Directs d’Usine et de Terroir',
      storyP1: 'Le négoce traditionnel en Afrique Centrale a trop longtemps souffert de chaînes de courtage opaques, de calibrages variables et de retards maritimes imprévisibles. Wardiere & Co. a été créée pour instaurer un standard d’excellence sans compromis.',
      ...
      storyP3: 'Nous avons reproduit ce modèle rigoureux sur nos autres filières : travail direct avec la Chambre Argentine du Popcorn (CAPPEC), les coopératives de tri textile d’Europe de l’Ouest et les carrières de gypse pur du bassin méditerranéen.',
      capacityLabel: 'Capacité d’Approvisionnement Annuelle',
      directLabel: 'Zéro Marge de Courtier',
      dualDesks: 'Double Direction Exécutive New York & Douala',
      charterEyebrow: 'Notre Charte d’Exploitation',
      charterTitle: 'Les Quatre Piliers Fondateurs de Wardiere & Co.',
      ...
      headquartersInfo: 'Siège social à New York avec Direction des Opérations à Douala, Cameroun',
    ...
    clients: {
      ...
      eligibilityTitle: 'Comment Devenir Grossiste Partenaire Certifié Wardiere',
    ...
    contact: {
      ...
      nyTitle: 'Bureau Exécutif de New York',
    ...
    footer: {
      ...
      tagline: 'Wardiere & Co. est une société de commerce transatlantique opérant des corridors d’importation conteneurisés majeurs vers le Port de Douala et la zone CEMAC.',
      brandDesc: 'Wardiere & Co. est une société de négoce transatlantique aux standards américains opérant des corridors d’importation conteneurisés majeurs vers le Port de Douala et la zone CEMAC.',
      ...
      copyright: '© 2026 Wardiere & Co. Tous droits réservés. Distributeur Exclusif du Papier Double A au Cameroun.'
    }
  }
};
